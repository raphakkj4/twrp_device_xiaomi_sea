...
# Brightness (commented to avoid UI crash; enable only if you confirm proper brightness range)
...
# Anti-Rollback Bypass (spoof security patch level)
PLATFORM_SECURITY_PATCH := 2099-12-31
VENDOR_SECURITY_PATCH := 2099-12-31
PLATFORM_VERSION := 99.87.36
PLATFORM_VERSION_LAST_STABLE := $(PLATFORM_VERSION)

# CRYPTO (DISABLED for now to prevent bootloop on FBE v2)
